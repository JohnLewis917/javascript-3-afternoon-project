...
//Code Here
let sumPop = (acc, currentValue) => acc + currentValue
let totalPopulation = populations.reduce(sumPop)
...
let orderTotals = orders.map(orders => orders.price * orders.tax + orders.price)
...
*/
let bobsStuff = purchases.filter((object) => object.owner === 'Bob')
let bobsTotal = bobsStuff.reduce((total, purchase) => total += purchase.price,0)
