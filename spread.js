...
//as arguments.  
//Invoke addNums, and use the spread operator to pass in the numbers from the 
...
/* Using the spread operator, concatentate the two arrays below and save 
//it to a variable named "combinedArrays" */
